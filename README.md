# galvis-post2-u2
Laboratorio 4 - Formulario de Registro con Validación HTML5

# Crear README.md con el siguiente contenido:
# Formulario de Registro HTML5 — Faiber Galvis
## Descripción
